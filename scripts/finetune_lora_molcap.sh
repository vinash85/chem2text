...
deepspeed llava/train/train_mem.py \
    ...
    --data_path /data/macaulay/LlavaVariants/InstructMol_LLaMa3/InstructMol_LLaMa3/data_preparation/filtered_output_remaining30k.pkl \
    ...
    --report_to none \
    > output_chem_all_finetune.txt 2>&1