...
# DATA_PATH="/data/macaulay/LlavaVariants/InstructMol_LLaMa3/InstructMol_LLaMa3/llava/datasets/train+selfies.pkl" # Path to the PubChem dataset
DATA_PATH="/data/macaulay/LlavaVariants/InstructMol_LLaMa3/InstructMol_LLaMa3/llava/datasets/train+selfies_115k.pkl" # Path to the PubChem dataset
